...
\def \titulo{Generation of infinite SNR signals in a constrained-loci device with minimal energy and noise}
\def \autor{Marcos Gómez Bracamonte}
\def \director{Fernando Alonso Díaz}
\def \ponente{Harry Nyquist}
